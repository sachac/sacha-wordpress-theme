...
$list = ''; $i = 0; ?>
    <tr><td><?php the_time('M j, Y') ?></td><td><a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php the_title(); ?></a></td><td><?php $cat = get_the_category(false); foreach ($cat as $category) { if ($category->name != 'emacs') {
if (0 < $i) { $list .= ', '; } 
