		...
		<div class="post hentry" id="post-<?php the_ID(); ?>">
			...
			<div class="postinfo">
<span class="postdate"><abbr class="published" title="<?php the_time('Y-m-d\TH:i:s\Z') ?>"><?php the_time('F jS, Y') ?></abbr></span> <?php _e('Categories: '); the_category(', '); ?> <?php the_tags(); ?> <?php _e('by'); ?> <?php the_author() ?> 
